...
\begin{itemize}
	\item Address cold start problem for both new users and tracks
	\item Use MagnaTagATune dataset containing user tagged songs
	\item Convolutional Neural Network Model trained on audio samples
	\item Based on Sander Dieleman work during internship @ Spotify
\end{itemize}
...
\begin{itemize}
	...
	\begin{itemize}
		\item Ground truth model based on collaborative filtering obtained from MagnaTagATune dataset
		\item Neural Network trained to minimize the error of latent representation (output) with the ground truth model
	\end{itemize}
\end{itemize}
